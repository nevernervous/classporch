...
export const getDashboard = ({userId, authToken}) => {
  return (dispatch) => {
    fetch(`${apiEndpoints.auth.base}/user/${userId}/dashboard`, {
      headers: {
...
export const sessionRequested = ({tutorId, skill, authToken, sessionStartTime, sessionEndTime, amountPaid, userId}) => {
  return async (dispatch) => {
    try {
      ...
      let resRaw = await fetch(`${apiEndpoints.auth.base}/session_requests/request/`, {
        method: "POST",
        headers: {
          'auth_token': authToken,
      ...
      let payRaw = await fetch(`${apiEndpoints.auth.base}/users/${userId}/pay`, {
        method: 'POST',
        headers: {
          'auth_token': authToken,
          'Content-type': 'application/json'
...
export const acceptSession = ({sessionId, authToken}) => {
  return async (dispatch) => {
    try {
      ...
      let resRaw = await fetch(`${apiEndpoints.auth.base}/session_requests/${sessionId}/accept`, {
        headers: {
          'auth_token': authToken,
          'Content-Type': 'application/json'
        },
...
export const rejectSession = ({sessionId, authToken}) => {
  return async (dispatch) => {
    try {
      ...
      let resRaw = await fetch(`${apiEndpoints.auth.base}/session_requests/${sessionId}/reject`, {
        headers: {
          'auth_token': authToken,
          'Content-Type': 'application/json'
        },
...
export const addMoneyToWallet = ({userId, authToken, amountToBeAdded, stripeToken, paymentType}) => {
  return async (dispatch) => {
    try {
      ...
      console.log(bodyObject)
      let resRaw = await fetch(`users/${userId}/add_money`, {
        method: 'POST',
        headers: {
          'auth_token': authToken,
          'Content-Type': 'application/json'
...
export const requestMoneyAction = ({userId, authToken, availableCredits, enteredCredits}) => {
  return async (dispatch) => {
    try {
      ...
      console.log(bodyObject)
      let resRaw = await fetch(`${apiEndpoints.auth.base}/users/${userId}/transact`, {
        method: 'POST',
        headers: {
          'auth_token': authToken,
          'Content-Type': 'application/json'
...
export const requestLinkAccount = ({userId, authToken, bankName, ifscCode, accountHolderName, accountNumber}) => {
  return async (dispatch) => {
    try {
      ...
      console.log(bodyObject)
      let resRaw = await fetch(`${apiEndpoints.auth.base}/users/${userId}/add_bank_details`, {
        method: 'POST',
        headers: {
          'auth_token': authToken,
          'Content-Type': 'application/json'

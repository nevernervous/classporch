...
class SuggestedTutors extends React.Component {
	...
	goPrevious = () => {
		...
		this.setState({ pageStart: pageStartPrev, displayedTutorProfiles:allTutorProfiles.slice(pageStartPrev*20,pageEndPrev*20) })
...
const mapStateToProps = ( {dashboard} ) => {
	...
	// console.log(suggestedTutors)
	// let copyTutors = suggestedTutors
	// suggestedTutors = [ ...suggestedTutors, ...copyTutors, ...suggestedTutors, ...suggestedTutors, ...copyTutors ]

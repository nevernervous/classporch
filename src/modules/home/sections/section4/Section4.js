            ...
            <Grid.Column width={6} textAlign='left' floated='left'>
                <div className='how-it-works-section'>
                    ...
                    <p className='section4-content'>
                        Our wide range of tutoring options enables us to meet the needs of all our students by improving and individualising their learning experience! We use industry standard technology to ensure learners get a great online tutoring experience.
To find your own tutor at ClassPorch, fill in the short form, wait for tutors to reply and offer their services and choose the tutoring option that will work best for you!                     </p>
                    <p className='section4-content'>
